...
import cs345feltsc.game.GameBuilder;
import cs345feltsc.interpret.BaseCommandParser;
import cs345feltsc.interpret.CommandParser;
import cs345feltsc.reader.Builder;
import cs345feltsc.reader.GameDescription;
...
public class GameMain {
    ...
    /**
     * Construct and run the game. This method creates a new GameBuilder object,
     * gets the named game description object. Builds the game and runs the
     * parser.
     * 
     * @param gameDescName
     *            name of the gamedescription class
     */
    private void run(String gameDescName) {
        Builder gb = new GameBuilder();
        GameDescription desc = getGameDescription(gameDescName, gb);
        if (desc != null) {
            Game game = desc.build(System.in, System.out);
            CommandParser ci = new BaseCommandParser(game);
            ci.run();
        }
    }

    /**
     * Get the GameDescription object.
     * 
     ...
     * @param gb
     *            This is the game builder object for the constructor for the
    ...
    private GameDescription getGameDescription(String gameDescription,
        ...
        try {
            ...
            GameDescription desc = GameDescription.class.cast(descObj);
            return desc;
