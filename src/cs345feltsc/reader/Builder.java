...
public interface Builder {
    ...
    /**
     * Do any setup that is required before calling any of the makeXXX methods.
     * This method does not have to do anything.
     */
    public void startBuild(InputStream in, PrintStream out);

    /**
     * Do any final work that is required after all the makeXXX methods have
     * been called. This method does not have to do anything.
     */
